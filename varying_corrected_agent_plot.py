...
np.savetxt('sim_result_data/NSE_Naive5.txt', NSE_Naive, fmt='%.1f')
np.savetxt('sim_result_data/NSE_DR5.txt', NSE_DR, fmt='%.1f')
np.savetxt('sim_result_data/NSE_RECON5.txt', NSE_RECON, fmt='%.1f')
np.savetxt('sim_result_data/NSE_GEN_RECON_with_cf5.txt', NSE_GEN_RECON_with_cf, fmt='%.1f')
np.savetxt('sim_result_data/agent_percentage_corrected5.txt', MMM, fmt='%d')
