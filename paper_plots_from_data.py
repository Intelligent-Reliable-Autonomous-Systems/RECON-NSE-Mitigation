...
plot_NSE_with_varying_corrected_agents(NSE_naive, NSE_dr, NSE_recon, agents_corrected)


# Figure 2: NSE penalty from all algorithms averaged over 5 environments [sim_for_varying_num_agents.py]
# load variables from textfiles
NSE_naive_tracker = np.loadtxt('sim_result_data/NSE_naive_tracker.txt', dtype=float)
NSE_recon_tracker = np.loadtxt('sim_result_data/NSE_recon_tracker.txt', dtype=float)
NSE_recon_gen_wo_cf_tracker = np.loadtxt('sim_result_data/NSE_recon_gen_wo_cf_tracker.txt', dtype=float)
NSE_recon_gen_with_cf_tracker = np.loadtxt('sim_result_data/NSE_recon_gen_with_cf_tracker.txt', dtype=float)
NSE_dr_tracker = np.loadtxt('sim_result_data/NSE_dr_tracker.txt', dtype=float)
