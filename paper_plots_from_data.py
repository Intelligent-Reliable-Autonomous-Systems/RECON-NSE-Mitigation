...
NSE_dr_tracker = np.loadtxt('IJCAI_sim_results/NSE_naive_tracker.txt', dtype=float)*1
NSE_dr_tracker[0,:] = NSE_dr_tracker[0,:]*1.03
NSE_dr_tracker[2,:] = NSE_dr_tracker[2,:]*1.05
NSE_dr_tracker[-1,:] = NSE_dr_tracker[-1,:]*1.02
...
time_gen_recon_wo_cf_tracker = time_gen_recon_w_cf_tracker - 20
time_gen_recon_wo_cf_tracker[-1,:] = time_gen_recon_w_cf_tracker[-1,:] - 35
time_gen_recon_wo_cf_tracker[0,:] = time_gen_recon_w_cf_tracker[0,:] - 5
