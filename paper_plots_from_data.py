...
# load variables from textfiles
time_recon_tracker = np.loadtxt('sim_result_data/results_julia/TIME_RECON_onr.txt', dtype=float)
time_gen_recon_wo_cf_tracker = np.loadtxt('sim_result_data/results_julia/TIME_GEN_RECON_WO_CF_onr.txt', dtype=float)
time_gen_recon_w_cf_tracker = np.loadtxt('sim_result_data/results_julia/TIME_GEN_RECON_WITH_CF_onr.txt', dtype=float)
