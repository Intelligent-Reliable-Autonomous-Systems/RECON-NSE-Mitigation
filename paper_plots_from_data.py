...
plot_effect_of_generalization(NSE_naive_tracker[2:], NSE_recon_tracker[2:], NSE_gen_recon_wo_cf_tracker[2:],
                              NSE_gen_recon_with_cf_tracker[2:], NSE_dr_tracker[2:], num_of_agents_tracker[2:], 'stochastic')
...
plot_time_scalability(time_recon_tracker[2:], time_gen_recon_wo_cf_tracker[2:], time_gen_recon_w_cf_tracker[2:], time_dr_tracker[2:],
                      num_of_agents_tracker[2:])
