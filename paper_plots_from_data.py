...
# load variables from textfiles
NSE_naive_tracker = np.loadtxt('sim_result_data/NSE_naive_tracker1.txt', dtype=float)
NSE_recon_tracker = np.loadtxt('sim_result_data/NSE_recon_tracker1.txt', dtype=float)
NSE_gen_recon_wo_cf_tracker = np.loadtxt('sim_result_data/NSE_gen_recon_wo_cf_tracker1.txt', dtype=float)
NSE_gen_recon_with_cf_tracker = np.loadtxt('sim_result_data/NSE_gen_recon_with_cf_tracker1.txt', dtype=float)
NSE_dr_tracker = np.loadtxt('sim_result_data/NSE_dr_tracker1.txt', dtype=float)
num_of_agents_tracker = np.loadtxt('sim_result_data/num_of_agents_tracker1.txt', dtype=int)
