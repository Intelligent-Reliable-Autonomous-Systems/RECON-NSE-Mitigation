...
def get_all_visualizations(domain, save_figures=True):
    ...
    plot_NSE_LinePlot_with_corrected_agents(NSE_naive, NSE_dr, NSE_recon, NSE_gen_recon_with_cf, NSE_considerate, 
                                            agents_corrected, domain, save_fig=save_figures)
    ...
    num_of_agents_tracker = np.loadtxt('sim_results/' + domain + '/num_of_agents_tracker.txt', dtype=int)
    plot_time_scalability(time_recon_tracker, time_gen_recon_wo_cf_tracker, time_gen_recon_with_cf_tracker, 
                          time_dr_tracker, time_considerate_tracker, num_of_agents_tracker, 
                          domain, save_fig=save_figures)