...
def get_all_visualizations(domain, save_figures=True):
    ...
    time_dr_tracker = np.loadtxt('sim_results/' + domain + '/1000Agents/Time_dr_tracker_1000.txt', dtype=float)
    time_considerate_tracker = np.loadtxt('sim_results/' + domain + '/1000Agents/Time_considerate_tracker_1000.txt', dtype=float)
    time_recon_tracker = np.loadtxt('sim_results/' + domain + '/1000Agents/Time_recon_tracker_1000.txt', dtype=float)
    time_gen_recon_wo_cf_tracker = np.loadtxt('sim_results/' + domain + '/1000Agents/Time_gen_recon_wo_cf_tracker_1000.txt', dtype=float)
    time_gen_recon_with_cf_tracker = np.loadtxt('sim_results/' + domain + '/1000Agents/Time_gen_recon_with_cf_tracker_1000.txt', dtype=float)
...
get_all_visualizations('salp',False)