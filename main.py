...
# initialize agent
agent1 = Agent(agent1_startLoc, Grid, 'L', '1')
agent2 = Agent(agent2_startLoc, Grid, 'M', '2')
agent3 = Agent(agent3_startLoc, Grid, 'S', '3')
agent4 = Agent(agent4_startLoc, Grid, 'L', '4')
agent5 = Agent(agent5_startLoc, Grid, 'S', '5')
